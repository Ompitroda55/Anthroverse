...
**The Rule of Law Principle** requires that all disputes be settled by an independent body, ensuring that all individuals—regardless of wealth, gender, or caste—are subject to the same law.
...
├── Handle cases within state jurisdiction
└── Exercise superintendence over lower courts

District Courts (District Level)
├── Handle district-level cases
├── Consider appeals from subordinate courts
└── Decide serious criminal offenses
...
- **Name Changes**: Mysore → Karnataka, Madras → Tamil Nadu
...
- **Power Distribution**: 
  - National subjects (defense, currency) → Union government
  - Regional/local matters → State governments
